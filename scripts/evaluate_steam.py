...
async def evaluate():
    ...
    report = f"""# Steam Offline Evaluation Report
...
"""
    ...
    with open("docs/model_reports/steam_evaluation.md", "w") as f:
        f.write(report)
        
    print("Evaluation complete. Report saved to docs/model_reports/steam_evaluation.md")
